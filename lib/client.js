...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const STYLES = [
			...
			".dpk-cost-title{color:var(--dsw-alias-label-secondary,#555);font-size:10px;line-height:14px;font-weight:600;text-transform:uppercase;letter-spacing:.1em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
			...
			".dpk-peak .dpk-cost-now{color:var(--dsw-alias-state-error-primary,#ef4444)}",
			".dpk-offpeak .dpk-cost-now{color:var(--dsw-alias-state-success-primary,#22c55e)}",
			"body:not([data-ds-dark-theme]) .dpk-peak .dpk-cost-now{color:#b91c1c}",
			"body:not([data-ds-dark-theme]) .dpk-offpeak .dpk-cost-now{color:#15803d}",
